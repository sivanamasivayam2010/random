...
//checks the functionality of For Providers tab
public class ForProvidersFunctionalityTest extends CorporateWellnessPage {

	@BeforeMethod(alwaysRun = true)
	public void openBrowser() {
		log.info("For Providers tab functionality Test");
		BaseUI.openBrowser();
	}

	@Test(retryAnalyzer = utilities.RerunFailedTestCase.class, groups = { "smoke" })
	public void forProvidersFunctionalityTest() {
		CorporateWellnessPage cw = new CorporateWellnessPage();
		BaseUI.logger = BaseUI.report.createTest("ForProvidersFunctionalityTest");
